...
import (
	...
	sdk "github.com/tangyu1018/goproxy/sdk/android-ios"
	...
	keygenx "github.com/tangyu1018/goproxy/services/keygen"
...
func initConfig() (err error) {
	...
	httpArgs.Baned = http.Flag("baned", "baned domain file , one domain each line").Default("baned").Short('B').String()
	...
	socksArgs.Baned = socks.Flag("baned", "baned domain file , one domain each line").Default("baned").Short('B').String()
